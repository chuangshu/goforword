...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="row">
    <div class="col-lg-12">
        <a href="admin.php?c=basic"><button type="button" class="btn <?php if($type == 1): ?>btn-primary<?php endif; ?>">基本管理</button></a>
        <a href="admin.php?c=basic&a=cache"><button type="button" class="btn <?php if($type == 2): ?>btn-primary<?php endif; ?>">缓存管理</button></a>
    </div>
</div>
		</div>
		<!-- /.row -->
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<label for="inputname" class="col-sm-3 control-label">更新首页缓存:</label>
		...
		<!--<div class = "form-group">
			...
			<input type="radio" name="cacheindex" id="optionsRadiosInline1" value="1">是
